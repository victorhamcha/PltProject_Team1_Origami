...
namespace DataSheetDialogueTypes{
	public class Feuille1{
		...
		public Feuille1(string eventName, int iD, string name, string sentence, string character){
	...
	public class SheetFeuille1: IEnumerable{
		public System.DateTime updated = new System.DateTime(2020,12,10,16,9,57);
		public readonly string[] labels = new string[]{"EventName","iD","Name","Sentence","character"};
		...
		public void Init() {
			_rows = new Feuille1[]{
					...
					new Feuille1("Jennifer Mayor",40,"Jennifer Mayor","<S:VOC_Facteur_Medium_01>Hello darling.",""),
					new Feuille1("Jennifer Mayor",41,"Jennifer Mayor","<S:VOC_Facteur_Medium_01>I’m the mayor of this little village.",""),
					new Feuille1("Jennifer Mayor",42,"Jennifer Mayor","<S:VOC_Facteur_Medium_01>Enjoy your visit in our community.",""),
					new Feuille1("Jennifer Mayor",43,"Jennifer Mayor","<S:VOC_Facteur_Medium_01>You can go visit our harbor up north.",""),
					new Feuille1("Jennifer Mayor",44,"Jennifer Mayor","<S:VOC_Facteur_Medium_01>And our famous windmill north-east from here.",""),
					new Feuille1("Jennifer Mayor",45,"Jennifer Mayor","<S:VOC_Facteur_Medium_01>You look like you enjoy a good panorama.",""),
					new Feuille1("Jennifer Mayor",46,"Jennifer Mayor","<S:VOC_Facteur_Medium_01>There is a little bench on the other part of the island near the bridge.",""),
					new Feuille1("Jennifer Mayor",47,"Jennifer Mayor","<S:VOC_Facteur_Medium_01>You can go sit there and enjoy the view !",""),
					new Feuille1("Jennifer Mayor",48,"Jennifer Mayor","<S:VOC_Facteur_Medium_01>There should also be my husband around.",""),
					new Feuille1("Jennifer Mayor",49,"Jennifer Mayor","<S:VOC_Facteur_Medium_01>If you are into sports and mediations, I’m sure he will gladly teach you some tricks.",""),
					...
					new Feuille1("Mary Miller",51,"Mary Miller","<S:VOC_Facteur_Medium_01>Hey there !",""),
					new Feuille1("Mary Miller",52,"Mary Miller","<S:VOC_Facteur_Medium_01>I thought I heard my husband arriving but it was you !",""),
					new Feuille1("Mary Miller",53,"Mary Miller","<S:VOC_Facteur_Medium_01>He must still be busy with the sheeps...",""),
					new Feuille1("Mary Miller",54,"Mary Miller","<S:VOC_Facteur_Medium_01>I wish he could help me with the windmill.",""),
					new Feuille1("Mary Miller",55,"Mary Miller","<S:VOC_Facteur_Medium_01>Guess I will have to figure out a solution myself...",""),
					new Feuille1("Mary Miller",56,"Mary Miller","<S:VOC_Facteur_Medium_01>The windmill is broken...",""),
					new Feuille1("Mary Miller",57,"Mary Miller","<S:VOC_Facteur_Medium_01>I can work without it.",""),
					new Feuille1("Mary Miller",58,"Mary Miller","<S:VOC_Facteur_Medium_01>I’ve already repaired it in the past.",""),
					new Feuille1("Mary Miller",59,"Mary Miller","<S:VOC_Facteur_Medium_01>But it’s a two person’s job, and Nicolas is not available right now.",""),
					new Feuille1("Mary Miller",60,"Mary Miller","<S:VOC_Facteur_Medium_01>Can’t blame him, it’s a lot of work to take care of these animals",""),
					new Feuille1("Mary Miller",61,"Mary Miller","<S:VOC_Facteur_Medium_01>Wow ! You are full of resources ! Thanks a lot, little one !",""),
					new Feuille1("Mr and Mrs Mailling",62,"Mr and Mrs Mailling","<S:VOC_Facteur_Medium_01>Hello you !",""),
					new Feuille1("Mr and Mrs Mailling",63,"Mr and Mrs Mailling","<S:VOC_Facteur_Medium_01>You must be the one we saw falling from that bird’s bag.",""),
					new Feuille1("Mr and Mrs Mailling",64,"Mr and Mrs Mailling","<S:VOC_Facteur_Medium_01>Thankfully you are not injured from that fall.",""),
					new Feuille1("Mr and Mrs Mailling",65,"Mr and Mrs Mailling","<S:VOC_Facteur_Medium_01>Well, you are a letter after all…",""),
					new Feuille1("Mr and Mrs Mailling",66,"Mr and Mrs Mailling","<S:VOC_Facteur_Medium_01>Go see our grand-son ! He is the postman, I’m sure he will be able to help you !",""),
					...
					new Feuille1("Mr and Mrs Mailling",68,"Mr and Mrs Mailling","<S:VOC_Facteur_Medium_01>You should have seen him when he was just a child.",""),
					...
					new Feuille1("Mr and Mrs Mailling",71,"Mr and Mrs Mailling","<S:VOC_Facteur_Medium_01>He fits so well in our little community !",""),
					new Feuille1("Mr and Mrs Mailling",72,"Mr and Mrs Mailling","<S:VOC_Facteur_Medium_01>Mac fits so well in our little community !",""),
					new Feuille1("Raymond Mayor",73,"Raymond Mayor","<S:VOC_Facteur_Medium_01>There are two important things in life.",""),
					new Feuille1("Raymond Mayor",74,"Raymond Mayor","<S:VOC_Facteur_Medium_01>Your body and your mind !",""),
					new Feuille1("Raymond Mayor",75,"Raymond Mayor","<S:VOC_Facteur_Medium_01>Never neglect these two.",""),
					new Feuille1("Raymond Mayor",76,"Raymond Mayor","<S:VOC_Facteur_Medium_01>I love to come here to do yoga. You should join me !",""),
					new Feuille1("Nicolas Miller",77,"Nicolas Miller","<S:VOC_Facteur_Medium_01>Oh hi !",""),
					new Feuille1("Nicolas Miller",78,"Nicolas Miller","<S:VOC_Facteur_Medium_01>Sorry I don’t have much time to talk, it’s a full time job to take care of these little devils !",""),
					new Feuille1("Nicolas Miller",79,"Nicolas Miller","<S:VOC_Facteur_Medium_01>I have to finish fast so I can go help my wife.",""),
					new Feuille1("Nicolas Miller",80,"Nicolas Miller","<S:VOC_Facteur_Medium_01>I have to finish fast so I can go help my wife.",""),
					new Feuille1("Tatiana Mayor",81,"Tatiana Mayor","<S:VOC_Facteur_Medium_01>My mother is the mayor of this village !",""),
					new Feuille1("Tatiana Mayor",82,"Tatiana Mayor","<S:VOC_Facteur_Medium_01>And my father is the strongest !",""),
					new Feuille1("Tatiana Mayor",83,"Tatiana Mayor","<S:VOC_Facteur_Medium_01>I have the best parents !",""),
					new Feuille1("Tatiana Mayor",84,"Tatiana Mayor","<S:VOC_Facteur_Medium_01>I have the best parents !",""),
					new Feuille1("Zoe et Tim",85,"Zoe & Tim","<S:VOC_Facteur_Medium_01>You are so tiny !",""),
					new Feuille1("Zoe et Tim",86,"Zoe & Tim","<S:VOC_Facteur_Medium_01>Are you lost ?",""),
					new Feuille1("Zoe et Tim",87,"Zoe & Tim","<S:VOC_Facteur_Medium_01>You can come play at our house if you want !",""),
					new Feuille1("Zoe et Tim",88,"Zoe & Tim","<S:VOC_Facteur_Medium_01>You can come play at our house if you want !",""),
					new Feuille1("Mouton",89,"Mouton","<S:VOC_SFX_Sheep_OneShot>Meeeeeeeh !",""),
					new Feuille1("Chien",90,"Chien","<S:VOC_SFX_Dog_Yap_03>Wouf !","")
				};
		}
